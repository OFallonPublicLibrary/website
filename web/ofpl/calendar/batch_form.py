...
MINUTES_INTERVAL = calendar_settings.TIMESLOT_INTERVAL.seconds // 60
SECONDS_INTERVAL = utils.time_delta_total_seconds(calendar_settings.DEFAULT_OCCURRENCE_DURATION)
...
class MultipleOccurrenceForm(forms.Form):
    ...
    def save(self):
        ...
        event.occurrence_set = Event.objects.get(pk=self.cleaned_data['event'].id).occurrences
